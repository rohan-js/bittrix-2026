#!/usr/bin/env python3
"""
Bit-Trix Assembler - ISA v6 with MSUB and SETLO
MSUB: R1 = R1 - Rd * Rs2 
SETLO: Rd = imm2 (0-3 in rs2 field) - replaces CLR+INC sequences
"""

OPCODES = {
    "NOP": 0, "ADD": 1, "SETLO": 2, "MSUB": 3, "DIV": 4, "LOAD": 5,
...
SETLO("R3", 0)           # R3 = 0 (hardware now supports this during load_pending)
E("LOADHI", "R2", "R3")  # R2 = h[0], starts load, R3 will auto-inc to 1
SETLO("R3", 1)           # R3 = 1 (explicit set during load_pending)
E("LOAD", "R3", "R3")    # R3 = x[1] (addr=1) - NOW R3 is definitely 1
